...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $insert_product = mysqli_query($con, "INSERT INTO `products`(`name`, `detail`, `price`, `image`) VALUES('$name', '$details', '$price', '$image')") or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="submit" value="add product" name="add_product" class="btn" style = "background:#865D36;">
   </form>
