...
<section class="heading">
    <h3 style ="color:#865D36;">your wishlist</h3>
    <p> <a href="index.php">home</a> / wishlist </p>
</section>

<section class="wishlist">

    <h1 class="title" style ="color:#865D36;">products added</h1>

    <div class="box-container">

    <?php
        $grand_total = 0;
        $select_wishlist = mysqli_query($con, "SELECT * FROM `wishlist` WHERE user_id = '$user_id'") or die('query failed');
