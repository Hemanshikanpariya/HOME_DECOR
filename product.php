...
if(isset($_POST['add_to_wishlist'])){
    ...
    if(mysqli_num_rows($check_wishlist_numbers) > 0){
        ...
        mysqli_query($con, "INSERT INTO `wishlist`(`user_id`, `pid`, `name`, `price`, `image`) VALUES('$user_id', '$product_id', '$product_name', '$product_price', '$product_image')") or die('query failed');
...
<head>
   ...
   <link rel="stylesheet" href="css/product.css, css/client.css">
...
<section class="heading">
    <h3 style="color:#865D36;">our shop</h3>
    <p> <a href="index.php">home</a> / shop </p>
</section>

<section class="products">

   <h1 class="title" style="color:#865D36; text-align:center; font-size:32px; text-transform:uppercase; letter-spacing:1px; margin:40px 0 25px; font-weight:600;">
   latest products
</h1>
